...
import os
import torch
from NVDIA_neir.photo_wct import PhotoWCT
import NVDIA_neir.process_stylization
...
# Load Propagator
if args.fast:
    from NVDIA_neir.photo_gif import GIFSmoothing
    p_pro = GIFSmoothing(r=35, eps=0.01)
else:
    from NVDIA_neir.photo_smooth import Propagator
...
for f in cont_img_list:
    ...
    NVDIA_neir.process_stylization.stylization(
